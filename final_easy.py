...
class H5Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.combination_embeddings == 'documentpool':
            ...
            #counter = 0
            embeddings_matrix = torch.zeros(1910,self.model_embedding.embedding_length)#.to(flair.device) #max number of tokens in document = 1910
...
def main():
    ...
    PATH = model_path  + full_model + str(max_epochs) + str(learning_rate) + '.pt'
    ...
    embeddings_models_list = [flair_embedding_forward,flair_embedding_backward,glove_embedding]
    ...
    print('Model for training {}, {} {}  lr = {}'.format(full_model, combined_embeddings, image_model , learning_rate))
