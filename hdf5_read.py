...
# hdf5_path = './HDF5_files/comprobacion.hdf5'
...
#     img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)#224x224x3 (0 or 255)
#     if img[165][165][0] != 0 or img[165][165][0] != 255:
#         print(img[165][165][0])
#         print(img[165][165][1])
#         print(img[165][165][2])
#         print(' ')
...
path = './HDF5_files/hdf5_small_tobacco_papers.hdf5'
#with h5py.File(path, 'r') as file:
dataset = h5py.File(path, 'r')
data = dataset.get('train_img')
img = data[789,:,:,:],
print(img[0][1][165][0])
print(img[0][165][165][1])
print(img[0][165][165][2])
# for i in range(0,790):
#     img = data[i,:,:,:],
#     print('Initial image',img[0].shape)
#     print(img[0][165][165][0])
#     print(img[0][165][165][1])
#     print(img[0][165][165][2])
#     print('')
img = Image.fromarray(img[0].astype('uint8'), 'RGB')
print('Image fromarray',img.size) #224x224
#for i in range(0,223):
print(img.getpixel((1, 165)))
...
print(image.shape)
print(image[0][1][165])
print(image[1][165][165])
print(image[2][165][165])
