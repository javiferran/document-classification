...
def main():
    ...
    h5_dataset = H5Dataset(path='./HDF5_files/hdf5_small_tobacco_full.hdf5', data_transforms=data_transforms['train'])
...
if __name__ == '__main__':
    class H5Dataset(Dataset):
        ...
        def __init__(self, path, data_transforms):
            self.file_path = path
            self.dataset = None
            self.data = None
            self.target = None
